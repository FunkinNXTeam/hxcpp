...
#define HX_STRINGI(s,len) ::String( const_cast<char *>(("\x80\x00\x00\x00" s)) + 4 ,len)
   ...
   #define HX_W(s,h0,h1) ::String( const_cast<char16_t *>(( HX_HEX_QUOTE_W(h1) HX_HEX_QUOTE_W(h0) u"\x8030\x0000" s )) + 4, (int)(sizeof(s)/2-1))
#else
   #define HX_W(s,h0,h1) ::String::create( (const char16_t *)(( HX_HEX_QUOTE_W(h1) HX_HEX_QUOTE_W(h0) u"\x8030\x0000" s )) + 4, (int)(sizeof(s)/2-1))
#endif
...
#ifdef HX_SMART_STRINGS
   #define HX_W(s,h0,h1) ::String( const_cast<char16_t *>(( HX_HEX_QUOTE_W(h0) HX_HEX_QUOTE_W(h1) u"\x0000\x8030" s )) + 4, (int)(sizeof(s)/2-1))
#else
   #define HX_W(s,h0,h1) ::String::create( (const char16_t *)(( HX_HEX_QUOTE_W(h0) HX_HEX_QUOTE_W(h1) u"\x0000\x8030" s )) + 4, (int)(sizeof(s)/2-1))
#endif
